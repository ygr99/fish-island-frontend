...
import { SendOutlined, UndoOutlined, ClearOutlined, SaveOutlined, PlayCircleOutlined } from '@ant-design/icons';
import { wsService } from '@/services/websocket';
import { getRoomByIdUsingGet, guessWordUsingPost, saveDrawDataUsingPost, startGameUsingPost } from '@/services/backend/drawGameController';
import './index.less';
            ...
            <Card 
              title={
                <div className="canvas-header">
                  ...
                  {isRoomOwner && roomInfo?.status === 'WAITING' && (
                    <Button 
                      type="primary" 
